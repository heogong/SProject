...
class RegProductType extends Component {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <View style={{marginBottom: 36}}>
            ...
            <View style={styles.fxDirRow}>
              <View style={styles.leftGuideTxtWrap}>
                <Text style={styles.leftGuideTxt}>추가할</Text>
              ...
              {ENTRIES1.map((entry, index) => (
                <TouchableOpacity onPress={ () => alert("ddd")}  key={index}>
                  <View 
                    ...
                    <Image source={require("./img/product/02_icon_white.png")} 
                      style={[styles.mb10, {
