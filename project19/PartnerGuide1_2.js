        ...
        <View style={styles.contentWrap}>
          ...
          >
            <View style={localStyles.guideImgWrap}>
              <Image source={require('./img/partner_guide/A42.png')} resizeMode="cover" style={localStyles.guideImg}/>  
            </View>

            <View>
              <Image source={require('./img/partner_guide/A43.png')} resizeMode="cover" style={localStyles.guideImg}/>  
            </View>

            <View>
              <Image source={require('./img/partner_guide/A44.png')} resizeMode="cover" style={localStyles.guideImg}/>  
            </View>
