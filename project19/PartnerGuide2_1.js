          ...
          <View>
            ...
            <View style={styles.fxDirRow}>
              <View style={styles.leftGuideTxtWrap}>
                ...
                <Text style={[styles.leftGuideTxt, {color: color.whiteColor, fontWeight: "bold"}]}>출장비 정책 및</Text>
                <Text style={[styles.leftGuideTxt, {color: color.whiteColor, fontWeight: "bold"}]}>정산·보고서 안내</Text>
              </View>
            </View>
