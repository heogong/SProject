          ...
          <View>
            ...
            <View style={styles.fxDirRow}>
              <View style={styles.leftGuideTxtWrap}>
                ...
                <Text style={[styles.leftGuideTxt, {color: color.whiteColor, fontWeight: "bold"}]}>A/S 매칭</Text>
                <Text style={[styles.leftGuideTxt, {color: color.whiteColor, fontWeight: "bold"}]}>진행 가이드</Text>
              </View>
            </View>
