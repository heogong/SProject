...
let MockCards = [
    ...
    new CardModel("die Katze", "the cat", "fakeDekID")
];
...
MockDecks.map(deck => {
    deck.addCard(new CardModel("der Hund", "the dog", "fakeDeckID"));
    deck.addCard(new CardModel("das Kind", "the child", "fakeDeckID"));
    deck.addCard(new CardModel("die Frau", "the woman", "fakeDeckID"));
    deck.addCard(new CardModel("die Katze", "the cat", "fakeDekID"));
    return deck;
});
