			...
			<Container style={styles.containerInnerPd}>
				...
				<View style={styles.contentWrap}>
						...
						<View style={styles.fx1}>
							<View style={[ styles.fx1, styles.fxDirRow, styles.alignItemsCenter ]}>
								...
								<Text
									style={[
										localStyles.timeTxt,
										{ textAlign: 'center', flex: 1, color: color.greyColor }
									]}
								>
									~
								</Text>
						...
						<View style={[ styles.fxDirRow, styles.justiConCenter, { marginBottom: 5 } ]}>
							<View style={[ styles.checkBoxWrap, { marginRight: 8 } ]}>
								{this.state.checkBox1 ? (
									<TouchableOpacity
										onPress={async () => {
											await this.setState({ checkBox1: false }), await this._handleFullBtnClick();
										}}
									>
										<Image
									...
									<TouchableOpacity
										onPress={async () => {
											await this.setState({ checkBox1: true }), await this._handleFullBtnClick();
										}}
									>
										<Image
							...
							<View style={[ styles.checkBoxWrap, { marginRight: 8 } ]}>
								{this.state.checkbox2 ? (
									<TouchableOpacity
										onPress={async () => {
											await this.setState({ checkbox2: false }),
									...
									<TouchableOpacity
										onPress={async () => {
											await this.setState({ checkbox2: true }),
												(BUSINESS_DAY.holidayWorkYn = this.state.checkbox2 ? 'Y' : 'N');
										}}
									>
										<Image
					...
					<View style={styles.footerBtnWrap}>
						<CustomButton onPress={this._regPartnerWork} disabled={this.state.btnDisabled}>
							선택완료
						</CustomButton>
					</View>
				</View>
