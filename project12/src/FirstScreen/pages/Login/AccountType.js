...
import { Container, Icon, Text, Item, Input, CheckBox } from 'native-base';
...
class AccountType extends Component {
    ...
    this.setState({delBtn1 : text.length > 0 ? true : false});
    ...
    this.setState({delBtn2 : text.length > 0 ? true : false});
		...
		return (
			...
			<KeyboardAwareScrollView enableOnAndroid={true} style={styles.containerInnerPd}>
				...
				<View style={styles.fx1}>
					...
					<View style={styles.fx1}>
						<Text style={[ styles.mb10, { textAlign: 'center', fontSize: 13, color: '#8e8e98' } ]}>
							쿨리닉의 회원이 되시면 다양한 혜택을 누리실 수 있습니다
						</Text>
                ...
                <Icon
									name="close-circle"
									style={[
                    localStyles.inputIcon, 
                    this.state.delBtn1 ? localStyles.show : localStyles.hide
                  ]}
									onPress={() => {
                    this.firstTextInput._root.clear();
                    this.setState({delBtn1 : false})
									}}
								/>
							</Item>
							...
							<Item regular style={[ styles.mb20, styles.inputWhBackWhBo ]}>
								...
								<Icon
									...
									style={[
                    localStyles.inputIcon, 
                    this.state.delBtn2 ? localStyles.show : localStyles.hide
                  ]}
									onPress={() => {
                    this.secondTextInput._root.clear();
                    this.setState({delBtn2 : false})
									}}
								/>
							</Item>
                ...
                <View style={styles.fxDirRow}>
                  ...
                  <Text style={localStyles.inputBottomTxt}>자동로그인</Text>
							...
							<View style={[ styles.alignItemsEnd, styles.mb20 ]}>
								<View>
									<TouchableOpacity onPress={Actions.InvaildId}>
										<Text
											style={[ localStyles.inputBottomTxt, { textDecorationLine: 'underline' } ]}
										>
											아이디와 비밀번호를 잊으셨나요?
										</Text>
									</TouchableOpacity>
							...
							<View style={[ styles.fxDirRow, styles.mb20 ]}>
								<View style={styles.fx1}>
									<CustomButton onPress={Actions.JoinAccountType} WhiteLineBtn={true}>
										회원가입
									</CustomButton>
								</View>
								<View style={{ paddingLeft: 6, paddingRight: 6 }} />
								<View style={styles.fx1}>
									<CustomButton onPress={() => this._login()} WhiteBackBtn={true}>
										로그인
									</CustomButton>
								</View>
							</View>
