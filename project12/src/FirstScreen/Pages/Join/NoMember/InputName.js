...
import { setNoMemberUsrNm } from '~/Redux/Actions';
...
class InputName extends Component {
  ...
  _nextButton = () => {
    this.props.onSetNoMemberUsrNm(this.state.usrNm);  // 리덕스 사용자 이름 SET
    Actions.NoMemberInputPhone();
  }
...
let mapDispatchToProps = (dispatch) => {
  return {
      onSetNoMemberUsrNm: (value) => dispatch(setNoMemberUsrNm(value))
  }
}
