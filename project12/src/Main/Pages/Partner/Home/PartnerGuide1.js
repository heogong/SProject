    ...
    return (
      <Container style={[styles.containerInnerPd, {backgroundColor: color.defaultColor}]}>
        ...
        <View style={styles.contentWrap}>
          ...
          <View>
            ...
            <View style={styles.fxDirRow}>
              <View style={stylesReg.leftGuideTxtWrap}>
                ...
                <Text style={[stylesReg.leftGuideTxt, {color: color.whiteColor, fontWeight: "bold"}]}>A/S 매칭</Text>
                <Text style={[stylesReg.leftGuideTxt, {color: color.whiteColor, fontWeight: "bold"}]}>진행 가이드</Text>
              </View>
            </View>
          ...
          <View>
            <TouchableOpacity onPress={Actions.PartnerGuide1Sub}>
