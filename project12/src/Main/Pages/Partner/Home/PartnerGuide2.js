...
class PartnerGuide2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <Container style={[styles.containerInnerPd, {backgroundColor: color.defaultColor}]}>
        ...
        <View style={styles.contentWrap}>
          ...
          <View>
            ...
            <View style={styles.fxDirRow}>
              <View style={stylesReg.leftGuideTxtWrap}>
                ...
                <Text style={[stylesReg.leftGuideTxt, {color: color.whiteColor, fontWeight: "bold"}]}>A/S 업체</Text>
                <Text style={[stylesReg.leftGuideTxt, {color: color.whiteColor, fontWeight: "bold"}]}>상세정보 가이드</Text>
              </View>
            </View>
          ...
          <View>
            <TouchableOpacity onPress={Actions.PartnerGuide2Sub}>
